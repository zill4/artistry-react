...
class ProgressBar extends React.Component {
    render() {
        ...
        return (React.createElement("div", { id: id, className: classNames.join(' '), role: "progressbar", "aria-valuenow": value, "aria-valuemin": min, "aria-valuemax": max, "aria-valuetext": text, style: style }, this.props.children ?
